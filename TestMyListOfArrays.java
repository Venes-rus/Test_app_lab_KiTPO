...
public class TestMyListOfArrays {
     ...
     */
    @Test
    public void sortListWithDoubleType() {
        userType = userFactory.getBuilderByTypeName("Double");

        for (int i = 0; i <= 15; i++) {
            actualListOfArrays.add(userType.parseValue((i * 1.0) + ""));
            expectedListOfArrays.add(userType.parseValue((i * 1.0) + ""));
        }
     ...
     */
    @Test
    public void sortListWithStringType() {
        userType = userFactory.getBuilderByTypeName("String");

        String[] values = {"apple", "banana", "cherry", "date", "elderberry", "fig", "grape", "honeydew", "ice cream", "jackfruit", "kiwi", "lemon", "mango", "nectarine", "orange", "papaya"};

        for (String value : values) {
            actualListOfArrays.add(userType.parseValue(value));
        }

        Arrays.sort(values);
        for (String value : values) {
            expectedListOfArrays.add(userType.parseValue(value));
        }
